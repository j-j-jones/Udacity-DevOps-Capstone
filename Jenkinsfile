pipeline {
  ...
  stages {
    stage('Kubernetes cluster') {
      steps {
        AWS_ROLE = "arn:aws:iam::724427472536:role/eksctl-udacity-devops-capstone-cluster-ServiceRole-1AJR0PR7FC5BK" // AWS role used to create EC2 infrastructure (instances, DNS entries...)
